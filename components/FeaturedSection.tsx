      ...
      <div className="container">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '6rem' }}>
          <div>
            ...
            <h2 style={{ fontSize: '2.4rem', fontWeight: 900, marginBottom: '15px', color: 'var(--charcoal)' }}>
              {t.featured.investments} <span className="gold-text">{t.featured.exclusive}</span>
            </h2>
            <p style={{ maxWidth: '600px', fontSize: '1.1rem', opacity: 0.7, lineHeight: '1.7', color: 'var(--charcoal)' }}>
              {t.featured.desc}
            </p>
          </div>
          <Link href="/sale" className="btn-secondary" style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '18px 48px', textDecoration: 'none' }}>
            {t.featured.allCollections} <ArrowRight size={20} />
          </Link>
        </div>
